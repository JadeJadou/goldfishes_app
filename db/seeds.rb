...
shark6 = Shark.create(name: "Lola", description: "Poisson ange, meilleure amie d'Oscar", price_per_day: 45, owner_id: user2.id, address: "Bora-bora", weight:"300grammes", skills:"Gentille, fidèle en amitié")
